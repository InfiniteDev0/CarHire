...
// --- Circle Component ---
const Circle = forwardRef<HTMLDivElement, CircleProps>(({ className, children, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
...
// --- Demo Component ---
export function AnimatedBeamMultipleOutputDemo({ className }: AnimatedBeamMultipleOutputDemoProps) {
