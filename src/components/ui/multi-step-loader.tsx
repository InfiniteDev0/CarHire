        ...
        return (
          ...
          >
            <div>
              ...
              {index <= value && (
                <CheckFilled
                  className={cn('text-white', value === index && 'opacity-100')}
                />
              )}
            </div>
            <span
    ...
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 h-full bg-black [mask-image:radial-gradient(900px_at_center,transparent_30%,white)]" />
        </motion.div>
      )}
    </AnimatePresence>
  );
